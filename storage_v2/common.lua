...
common.BUFFER_NAME = "buffer"

common.VAULT_PROTOCOL = "storage_vault_relay"
common.VAULT_COUNT = 132

-- "vault_x"
common.VAULTS = {}
for i = 0, common.VAULT_COUNT - 1 do
    common.VAULTS[#common.VAULTS + 1] = "vault_" .. i
end

-- vault_x = "storage_y"
common.VAULT_TO_STORAGE = {}
for i = 0, common.VAULT_COUNT - 1 do
    common.VAULT_TO_STORAGE["vault_" .. i] = "storage_" .. math.floor(i / 6)
end
